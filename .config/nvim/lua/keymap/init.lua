...
--     ["n|<Leader>ce"]     = map_cr('Lspsaga show_line_diagnostics'):with_noremap():with_silent(),
    ...
    -- coc
    ["n|gd"]             = map_cr('<Plug>(coc-definition)'):with_noremap():with_silent(),
    ["n|gr"]             = map_cr('<Plug>(coc-references)'):with_noremap():with_silent(),
    ["n|gi"]             = map_cr('<Plug>(coc-implementation)'):with_noremap():with_silent(),
    ["n|gt"]             = map_cr('<Plug>(coc-type-definition)'):with_noremap():with_silent(),
    ...
    ["n|<Leader>."]      = map_cu('DashboardFindFile'):with_noremap():with_silent(),
