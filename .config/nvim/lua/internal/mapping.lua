...
--     ["n|<Leader>fs"]     = map_cu('Telescope gosource'):with_noremap():with_silent(),
    -- Clap
    ["n|<Leader>cc"]     = map_cr('Clap coc_commands'):with_noremap():with_silent(),
    ["n|<Leader>:"]      = map_cr('Clap command'):with_noremap():with_silent(),
    ["n|<Leader>cm"]     = map_cr('Clap command'):with_noremap():with_silent(),
    ["n|<Leader>ch"]     = map_cr('Clap history'):with_noremap():with_silent(),
    ["n|<Leader>cf"]     = map_cr('Clap files ++finder=rg --ignore --hidden --files'):with_noremap():with_silent(),
    ["n|<Leader>ca"]     = map_cr('Clap grep'):with_noremap():with_silent(),
    ["n|<C-x><C-f>"]     = map_cr('Clap filer'):with_noremap():with_silent(),
    ["n|<Leader>cb"]     = map_cr('Clap buffers'):with_noremap():with_silent(),
    ["n|<Leader>,"]      = map_cr('Clap buffers'):with_noremap():with_silent(),
    ["n|<Leader>."]      = map_cr('Clap files ++finder=rg --ignore --hidden --files'):with_noremap():with_silent(),
